...
apiKey = "c606224329f6a3a18d25a22436cea960"
apiSecret = "p6Ne820xWPrGekpAd1cdtyF6MTmgT1V55DIotyCWENuSQj6IqseFdfBjyRoFdQ9FqrNgbSovaF3fw2SsoSjgzQ=="
passphrase = "lb3t6qfupvo"

auth_client = cbpro.AuthenticatedClient(apiKey,apiSecret,passphrase, api_url="https://api-public.sandbox.pro.coinbase.com")
...
specificID = '270421d1-2caa-4444-97e4-5f6c53a442bf'
...
while True:
    ...
    # try:
    historicData = auth_client.get_product_historic_rates('BTC-USD', granularity=period)
